...
platecascade = cv2.CascadeClassifier("C:\Users\91727\Desktop\haarcascade_russian_plate_number.xml")
minArea = 500
...
while True:
    ...
    imgGray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)ṇ
    ...
    for (x, y, w, h) in numberplates:
        ...
        if area > minArea:
            ...
            filename = f"C:\Users\91727\Desktop\license images"_{ts}.jpg" # generate a unique filename based on the timestamp
